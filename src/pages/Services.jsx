    ...
    return (
        <div className="min-h-screen w-full bg-gray-100 p-8">
            <div className="max-w-7xl mx-auto">
                <h1 className="text-4xl font-bold text-center text-gray-800 mb-12">Nuestros Servicios</h1>
            
                <section className="bg-white shadow-lg rounded-lg p-6 mb-12">
                    <h2 className="text-3xl font-semibold text-gray-700 mb-4">Servicio de Entrega</h2>
                    <div className="flex flex-col md:flex-row items-center md:items-start">
                        <img src="/imagen-entrega.png" alt="Servicio de Entrega" className="w-full md:w-1/2 rounded-lg mb-6 md:mb-0 md:mr-6" />
                ...
                <section className="bg-white shadow-lg rounded-lg p-6 mb-12">
                    <h2 className="text-3xl font-semibold text-gray-700 mb-4">Entregas Programadas</h2>
                    <div className="flex flex-col md:flex-row items-center md:items-start">
                        <img src="/imagen-programada.png" alt="Entregas Programadas" className="w-full md:w-1/2 rounded-lg mb-6 md:mb-0 md:mr-6" />
                        <p className="text-gray-600 leading-relaxed">
                ...
                <section className="bg-white shadow-lg rounded-lg p-6 mb-12">
                    <h2 className="text-3xl font-semibold text-gray-700 mb-4">Retiro en Local</h2>
                    <div className="flex flex-col md:flex-row items-center md:items-start">
                        <img src="/imagen-retiro.png" alt="Retiro en Local" className="w-full md:w-1/2 rounded-lg mb-6 md:mb-0 md:mr-6" />
                        <p className="text-gray-600 leading-relaxed">
                ...
                <section className="bg-white shadow-lg rounded-lg p-6 mb-12">
                    <h2 className="text-3xl font-semibold text-gray-700 mb-4">Buffet Propio</h2>
                    <div className="flex flex-col md:flex-row items-center md:items-start">
                        <img src="/imagen-buffet.png" alt="Buffet Propio" className="w-full md:w-1/2 rounded-lg mb-6 md:mb-0 md:mr-6" />
                        <p className="text-gray-600 leading-relaxed">
