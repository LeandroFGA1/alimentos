    ...
    return (
        <div className="min-h-screen w-full bg-bg1 p-8">
            <div className="max-w-7xl mx-auto">
                ...
                <section className="bg-white/65 shadow-lg rounded-lg p-6 mb-12 flex flex-col">
                    <h2 className="text-3xl font-semibold text-black/90 mb-4">Servicio de Entrega</h2>
                    <div className="flex flex-col md:flex-row items-center md:items-start">
                        <img src="https://upload.wikimedia.org/wikipedia/commons/f/f7/Lemon_-_whole_and_split.jpg" alt="Servicio de Entrega" className="w-full md:w-1/5 rounded-lg mb-6 md:mb-0 md:mr-6" />
                ...
                <section className="bg-white/65 shadow-lg rounded-lg p-6 mb-12">
                    ...
                    <div className="flex flex-col md:flex-row items-center md:items-start">
                        <img src="https://upload.wikimedia.org/wikipedia/commons/f/f7/Lemon_-_whole_and_split.jpg" alt="Entregas Programadas" className="w-full md:w-1/5 rounded-lg mb-6 md:mb-0 md:mr-6" />
                        <p className="text-black/80 leading-relaxed text-xl">
                ...
                <section className="bg-white/65 shadow-lg rounded-lg p-6 mb-12">
                    ...
                    <div className="flex flex-col md:flex-row items-center md:items-start">
                        <img src="https://upload.wikimedia.org/wikipedia/commons/f/f7/Lemon_-_whole_and_split.jpg" alt="Retiro en Local" className="w-full md:w-1/5 rounded-lg mb-6 md:mb-0 md:mr-6" />
                        <p className="text-black/80 leading-relaxed text-xl">
                ...
                <section className="bg-white/65 shadow-lg rounded-lg p-6 mb-12">
                    ...
                    <div className="flex flex-col md:flex-row items-center md:items-start">
                        <img src="https://upload.wikimedia.org/wikipedia/commons/f/f7/Lemon_-_whole_and_split.jpg" alt="Buffet Propio" className="w-full md:w-1/5 rounded-lg mb-6 md:mb-0 md:mr-6" />
                        <p className="text-black/80 leading-relaxed text-xl">
