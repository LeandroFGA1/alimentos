    ...
    return (
        <div className="min-h-screen w-full bg-bg1 p-8">
            <div className="max-w-7xl mx-auto">
                ...
                <section className="bg-white/60 shadow-lg rounded-lg p-6 mb-12">
